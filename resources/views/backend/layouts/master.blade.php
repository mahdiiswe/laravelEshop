                ...
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a class="submenu" href="submenu2.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Show Category</span></a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a class="submenu" href="submenu2.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Show Product</span></a></li>
                        </ul>
                    </li>
...
<footer>
    ...
    <p>
        <span style="text-align:left;float:left">&copy; {{ date('Y') }} <a href="http://bootstrapmaster.com/" alt="Bootstrap Themes">{{ config('app.name') }}</a></span>
